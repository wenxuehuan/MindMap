...
public static class Localization
{
    ...
    private static readonly Dictionary<string, string> ChineseStrings = new()
    {
        ...
        ["AddSummary"] = "添加合并节点",
        ["AddConnection"] = "添加连线",
        ["ShowMindMapPane"] = "显示思维导图",
        ["ShowMarkdownPane"] = "显示 Markdown 文档",
        ["SwapWorkspacePanes"] = "交换导图与 Markdown 位置",
        ["DragPaneToReorder"] = "拖动到左侧或右侧调整位置",
        ["CloseMindMapPane"] = "关闭思维导图面板",
        ["CloseMarkdownPane"] = "关闭 Markdown 文档面板",
        ["MindMapPaneTitle"] = "思维导图",
        ["MarkdownDocumentTitle"] = "Markdown 文档",
        ["ShowMarkdownOutline"] = "展开 Markdown 目录",
        ["HideMarkdownOutline"] = "收起 Markdown 目录",
        ["NodeNote"] = "节点备注",
        ["EditNodeNote"] = "编辑备注",
        ["AddNodeNote"] = "添加备注",
        ["DeleteNodeNote"] = "删除备注",
        ["DeleteNodeNotePrompt"] = "确定删除此节点的备注吗？此操作可以撤销。",
        ["MarkdownPlaceholder"] = "在这里开始编写 Markdown 文档…",
        ["NodeNotePlaceholder"] = "为这个节点添加 Markdown 备注…",
        ["MarkdownHeading"] = "标题",
        ["MarkdownBold"] = "粗体 Ctrl+B",
        ["MarkdownItalic"] = "斜体 Ctrl+I",
        ["MarkdownStrike"] = "删除线",
        ["MarkdownQuote"] = "引用",
        ["MarkdownAlignLeft"] = "左对齐",
        ["MarkdownAlignCenter"] = "居中对齐",
        ["MarkdownAlignRight"] = "右对齐",
        ...
        ["MarkdownLink"] = "链接",
        ["MarkdownImage"] = "图片",
        ["MarkdownImageFileFilter"] = "图片文件 (*.png;*.jpg;*.jpeg;*.gif;*.webp)|*.png;*.jpg;*.jpeg;*.gif;*.webp",
        ["MarkdownTable"] = "表格",
        ["ImportMarkdown"] = "导入 Markdown…",
        ["ExportMarkdown"] = "导出 Markdown…",
        ["MarkdownFileFilter"] = "Markdown 文档 (*.md;*.markdown)|*.md;*.markdown|所有文件 (*.*)|*.*",
        ["ReplaceMarkdownConfirm"] = "当前 Markdown 文档已有内容。是否用导入的文件替换？此操作可以撤销。",
        ["MarkdownImportFailed"] = "导入 Markdown 失败",
        ["MarkdownExportFailed"] = "导出 Markdown 失败",
        ["MarkdownImported"] = "已导入 Markdown 文档：{0}",
        ["MarkdownExported"] = "已导出 Markdown 文档：{0}",
        ["MarkdownMissingImages"] = "以下图片未找到或格式不受支持，原始引用已保留：\n{0}",
        ["HideSidebar"] = "隐藏侧栏",
        ["ShowSidebar"] = "显示侧栏",
        ...
        ["ToolbarExpanded"] = "工具栏已展开。",
        ["ToolbarCollapsed"] = "工具栏已收起。",
        ["MarkdownOutlineExpanded"] = "Markdown 目录已展开。",
        ["MarkdownOutlineCollapsed"] = "Markdown 目录已收起。",
        ["SelectedNode"] = "已选择：{0}",
    ...
    private static readonly Dictionary<string, string> EnglishStrings = new()
    {
        ...
        ["ShowMindMapPane"] = "Show mind map",
        ["ShowMarkdownPane"] = "Show Markdown document",
        ["SwapWorkspacePanes"] = "Swap mind map and Markdown panes",
        ["DragPaneToReorder"] = "Drag to the left or right to reposition",
        ["CloseMindMapPane"] = "Close mind-map pane",
        ["CloseMarkdownPane"] = "Close Markdown pane",
        ["MindMapPaneTitle"] = "Mind map",
        ["MarkdownDocumentTitle"] = "Markdown document",
        ["ShowMarkdownOutline"] = "Show Markdown Outline",
        ["HideMarkdownOutline"] = "Hide Markdown Outline",
        ["NodeNote"] = "Node note",
        ["EditNodeNote"] = "Edit note",
        ["AddNodeNote"] = "Add note",
        ["DeleteNodeNote"] = "Delete note",
        ["DeleteNodeNotePrompt"] = "Delete this node note? You can undo this action.",
        ["MarkdownPlaceholder"] = "Start writing your Markdown document…",
        ["NodeNotePlaceholder"] = "Add a Markdown note for this node…",
        ["MarkdownHeading"] = "Heading",
        ["MarkdownBold"] = "Bold Ctrl+B",
        ["MarkdownItalic"] = "Italic Ctrl+I",
        ["MarkdownStrike"] = "Strikethrough",
        ["MarkdownQuote"] = "Quote",
        ["MarkdownAlignLeft"] = "Align left",
        ["MarkdownAlignCenter"] = "Align center",
        ["MarkdownAlignRight"] = "Align right",
        ["MarkdownUnorderedList"] = "Bulleted list",
        ...
        ["MarkdownLink"] = "Link",
        ["MarkdownImage"] = "Image",
        ["MarkdownImageFileFilter"] = "Image files (*.png;*.jpg;*.jpeg;*.gif;*.webp)|*.png;*.jpg;*.jpeg;*.gif;*.webp",
        ["MarkdownTable"] = "Table",
        ["ImportMarkdown"] = "Import Markdown…",
        ["ExportMarkdown"] = "Export Markdown…",
        ["MarkdownFileFilter"] = "Markdown documents (*.md;*.markdown)|*.md;*.markdown|All files (*.*)|*.*",
        ["ReplaceMarkdownConfirm"] = "The current Markdown document is not empty. Replace it with the imported file? You can undo this operation.",
        ["MarkdownImportFailed"] = "Markdown import failed",
        ["MarkdownExportFailed"] = "Markdown export failed",
        ["MarkdownImported"] = "Imported Markdown document: {0}",
        ["MarkdownExported"] = "Exported Markdown document: {0}",
        ["MarkdownMissingImages"] = "These images were missing or unsupported; their original references were preserved:\n{0}",
        ...
        ["NodesDeleted"] = "Deleted {0} nodes, including descendants.",
        ...
        ["UnsupportedFileVersion"] = "This file uses format version {0}; this app supports up to version {1}. Update the app to open it.",
        ...
        ["MarkdownOutlineExpanded"] = "Markdown outline expanded.",
        ["MarkdownOutlineCollapsed"] = "Markdown outline collapsed.",
